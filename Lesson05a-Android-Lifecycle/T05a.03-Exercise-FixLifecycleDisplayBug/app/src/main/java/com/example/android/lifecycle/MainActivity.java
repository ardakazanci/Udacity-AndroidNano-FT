...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (COMPLETED) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    private static final ArrayList<String> mLifecycleCallbacks = new ArrayList<>();
    /*
    Ayrıca, not: ArrayList dizininin statik bir değişken olarak bildirilmemesi durumunda onDestroy ve onStop görüntülenmeyecektir .
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (COMPLETED) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for (int i = mLifecycleCallbacks.size() - 1; i >= 0; i--) {
            mLifecycleDisplay.append(mLifecycleCallbacks.get(i) + "\n");
        }
        // TODO (COMPLETED) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // TODO (COMPLETED) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // TODO (COMPLETED) Add the ON_DESTROY String to the front of mLifecycleCallbacks
