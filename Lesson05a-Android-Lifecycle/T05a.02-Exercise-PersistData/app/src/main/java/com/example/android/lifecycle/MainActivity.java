...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (COMPLETED) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (COMPLETED) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
        if(savedInstanceState !=null){

            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){ // İçerik key'i aracılığıyla verileri çağırıyoruz.

                String allPreviousLifecyclerCallbacks = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(allPreviousLifecyclerCallbacks);
    ...
    // TODO (COMPLETED) Override onSaveInstanceState
    // Do steps 3 - 5 within onSaveInstanceState
    // TODO (COMPLETED) Call super.onSaveInstanceState
    // TODO (COMPLETED) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // TODO (COMPLETED) Put the text from the TextView in the outState bundle
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String lifecyclerDisplayTextViewContents = mLifecycleDisplay.getText().toString(); // İlgili activity durum bilgisini kaydettik
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY,lifecyclerDisplayTextViewContents); // put string ile verileri gönderiyoruz.
