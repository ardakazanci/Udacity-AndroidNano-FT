    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (COMPLETED) Store ChildActivity.class in a Class object called destinationActivity

                Class destinationActivity = ChildActivity.class;

                // TODO (COMPLETED) Create an Intent to start ChildActivity

                Intent i = new Intent(context,destinationActivity);

                // TODO (COMPLETED) Replace the Toast with code to start ChildActivity
               startActivity(i);
