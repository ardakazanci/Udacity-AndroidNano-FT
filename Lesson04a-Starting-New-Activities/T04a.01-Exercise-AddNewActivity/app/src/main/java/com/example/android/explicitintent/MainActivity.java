...
// TODO (COMLETED) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// TODO (COMPLETED) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// TODO (COMPLETED) Give your TextView an ID of tv_display
// TODO (COMPLETED) Set the text to something that indicates this is default text being displayed
// TODO (COMPLETED) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// TODO (COMPLETED) Create a TextView field to display your message
// TODO (COMPLETED) Get a reference to your TextView in Java