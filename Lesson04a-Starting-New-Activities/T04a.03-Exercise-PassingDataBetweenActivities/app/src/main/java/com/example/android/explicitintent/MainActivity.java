    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO (COMPLETED) Retrieve the text from the EditText and store it in a variable
                String girilenDeger = mNameEntry.getText().toString();
                /*
                ...
                // TODO (COMPLETED) Use the putExtra method to put the String from the EditText in the Intent
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, girilenDeger);
                /*
