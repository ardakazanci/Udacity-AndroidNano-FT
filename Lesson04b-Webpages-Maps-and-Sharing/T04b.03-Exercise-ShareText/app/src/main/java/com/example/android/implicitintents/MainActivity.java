...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODO (COMPLETED) Specify a String you'd like to share
        String text = "Merhaba Paylaşma İçeriği";
        // TODO (COMPLETED) Replace the Toast with shareText, passing in the String from step 5
        shareText(text);
    }
    ...
    // TODO (COMPLETED) Create a void method called shareText that accepts a String as a parameter
    ...
    // TODO (COMPLETED) Create a String variable called mimeType and set it to "text/plain"

    // TODO (COMPLETED) Create a title for the chooser window that will pop up

    // TODO (COMPLETED) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
}