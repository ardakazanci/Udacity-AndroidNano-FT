...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // TODO (COMPLETED) Store an address in a String
        String addressString = "1600 Amphitheatre Parkway, CA";
        // TODO (COMPLETED) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address
        ...
        // TODO (COMPLETED) Replace the Toast with a call to showMap, passing in the Uri from the previous step
       showMap(addressUri); // GEO Şemasına sahip uri metota gönderilip activity başlatılacak
    }
    ...
    // TODO (COMPLETED) Create a method called showMap with a Uri as the single parameter
    ...
    // TODO (COMPLETED) Create an Intent with action type, Intent.ACTION_VIEW

    // TODO (COMPLETED) Set the data of the Intent to the Uri passed into this method
